...
export function PreviewBar() {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-1 bg-ink px-6 py-1.5 text-2xs uppercase tracking-[0.12em] text-ink-foreground">
      ...
      <nav aria-label="Preview" className="flex items-center gap-3">
